...
- **Neural general circulation models for weather and climate.**
  D Kochkov, J Yuval, …, **S Hoyer**. *Nature* (2024). [510 citations]
...
- **Learning skillful medium-range global weather forecasting.**
  R Lam et al. *Science* (2023). [1,892 citations]
...
- **Machine learning–accelerated computational fluid dynamics.**
  D Kochkov, …, **S Hoyer**. *PNAS* (2021). [1,350 citations]
...
- **Lagrangian neural networks.**
  M Cranmer, S Greydanus, **S Hoyer**, et al. *arXiv* (2020). [738 citations]
- **Kohn–Sham equations as regularizer: building prior knowledge into
  machine-learned physics.**
  L Li, **S Hoyer**, et al. *Physical Review Letters* (2021). [215 citations]
...
- **Neural reparameterization improves structural optimization.**
  **S Hoyer**, et al. *NeurIPS workshop* (2019). [120 citations]

## Fundamental AI research

- **Efficient and modular implicit differentiation.**
  M Blondel et al. *NeurIPS* (2022). [397 citations]
- **The Cramér distance as a solution to biased Wasserstein gradients.**
  M Bellemare et al. *arXiv* (2017). [507 citations]
